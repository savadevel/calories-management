...
public class MealsUtil {
    public static final int EXCESS_CALORIES_PER_DAY = 2000;
    public static final List<Meal> mealsPerDay = new CopyOnWriteArrayList<Meal>() {{
...
//                      Collectors.toMap(Meal::getDate, Meal::getCalories, Integer::sum)
    ...
    public static List<MealTo> getMealsToPerDay() {
        return filteredByStreams(mealsPerDay, LocalTime.MIN, LocalTime.MAX, EXCESS_CALORIES_PER_DAY);
    }
